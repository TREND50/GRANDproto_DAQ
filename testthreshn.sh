echo "##### testthresh.sh: checking threshold on noise ###########"""
sleep 1
...
do
  ...
  do
    ...
    echo $nb ' trigger(s).'
    echo $trig $th $nb >> $REPTEST/threshn_b$1.txt
  done
done

python ~/GRANDproto/GRANDproto_python/anaThresh.py $1 n $REPTEST
