    ...
    for (;;)
        {
            ...
            bool all_blank = true;
            if (std::all_of (line.begin (), line.end (), [](char c) { return std::isblank (c); }) ||
                line[0] == '#')
                {
                    continue;
                }
                    ...
                    if (type == "SCALAR")
                        {
                            ...
                            std::string token;
                            iss >> token;
                            if (message_type == "TRENDSlc" &&
                                (key == "VPower2" || key == "VPower3"))
                                {
                                    ...
                                    value = x / factor;
                                     ...
                                     (key == "VPower1" || key == "VPower4" || key == "VPower5" || key == "VPower6"))
                                {
                                    ...
                                    value = x / factor;
                                     ...
                                     (key == "Th1-" || key == "Th1+" || key == "Th2-" ||
                                      key == "Th2+" || key == "Th3-" || key == "Th3+"))
                                {
                        ...
                        {
                            std::cerr << "Error, illegal message type:" << type
                                      << " , neither VECTOR, nor SCALAR" << std::endl;
